...
if ($_GET['status']==0){ 
 ...
 $insertSQL = sprintf("UPDATE sis_plantilla_articulos SET status=%s WHERE id_articulo=%s",  
							 
                       GetSQLValueString($status, "int"),
                       GetSQLValueString($_GET['id_articulo'], "int"));
...
<meta http-equiv="Refresh" content="1;url=index.php?mod=gestor-blog">
</head>
