...
$query_categoria = "SELECT * FROM sis_productos_categoria_padre";
...
<div class="tablaestilo">
		<table summary="Usuarios" width="90%">
				<caption>LISTADO DE CATEGORIA PADRE </caption>
				<thead>
              <tr >
              <th width="40%" height="35"  align="center" scope="col" ><b>Nombre de la Categor&iacute;a</b></th>
              <th width="20%" align="center" scope="col"><b>Imagen Categor&iacute;a</b></th>
