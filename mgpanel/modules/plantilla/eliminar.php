...
$id=$_GET['id'];
	...
	if($id>0) {
		echo "<center><br><div class='tablaestilo'><table width='90%'><caption>Eliminando M&oacute;dulo!</caption></table></center>";

		$sql = "DELETE FROM sis_plantilla_modulos WHERE id=$id LIMIT 1"; 
