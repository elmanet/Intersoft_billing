...
$(function(){
 $("#grabar").click(function(){
    ...
    CKEDITOR.instances['des_marca'].updateElement();
 	...
 	if($("#nombre_marca").val().length < 3) {  
        $('#msgerror').show();
        $("#msgerror p").html("<strong>Error!</strong> Debes agregar un Nombre al Proveedor").show();
 ...
 var url = "modules/facturacion-proveedor/grabando.php"; // El script a dónde se realizará la petición.
 ...
 <form   id="captchaform" method="POST"  enctype="multipart/form-data" >
 	...
 	<table>
		<tr>	
			...
			<input class="form-control" type="text" id="nombre_marca" placeholder="Nombre del Proveedor" name="nombre_marca" value="" style="width:300px;" />
			</div>
      </td>
		</tr>
...
<tr><td>&nbsp;</td></tr>
		...
		<td colspan="2" align="center"><a href="index.php?mod=gestor-proveedor" class="btn btn-danger btn-lg"><i class="glyphicon glyphicon-remove"></i><span> Cancelar</span></a>	&nbsp;&nbsp;&nbsp;	 <a href="#" id="grabar" class="btn btn-primary btn-lg"><i class="fa fa-th-large"></i><span> Grabar Nuevo</span></a></td>
		</tr>
 		</table>
