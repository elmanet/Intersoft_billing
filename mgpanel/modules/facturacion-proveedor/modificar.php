...
$query_categoria = sprintf("SELECT * FROM sis_factura_proveedor WHERE id=%s", GetSQLValueString($colname_categoria, "int"));
...
$(function(){
 $("#grabar").click(function(){
 	...
 	if($("#nombre_marca").val().length < 3) {  
        $('#msgerror').show();
        $("#msgerror p").html("<strong>Error!</strong> Debe tener un nombre el Proveedor").show();
 ...
 var url = "modules/facturacion-proveedor/modificando.php"; // El script a dónde se realizará la petición.
    ...
    $.ajax({
         ...
         type: "POST",
           ...
           success: function(data) {
               ...
               setTimeout(function() {
				     url = "index.php?mod=gestor-proveedor";
...
<form   id="captchaform" method="POST"   enctype="multipart/form-data" >
	...
	<table>
		<tr>	
			...
			<input class="form-control" type="text" id="nombre_marca" placeholder="Nombre del Proveedor" name="nombre_marca" value="<?php echo $row_categoria['nombre_marca'];?>" style="width:300px;" />
			</div>
      </td>
		</tr>
...
<tr><td>&nbsp;</td></tr>
		...
		<td colspan="2" align="center"><a href="index.php?mod=gestor-proveedor" class="btn btn-danger btn-lg"><i class="glyphicon glyphicon-remove"></i><span> Cancelar</span></a>	&nbsp;&nbsp;&nbsp;	 <a href="#" id="grabar" class="btn btn-primary btn-lg"><i class="fa fa-th-large"></i><span> Modificar</span></a></td>
		</tr>
 		</table>
