...
<table style="width:100%">
		...
		<td colspan="2" align="center">
			...
			<a href="index.php?mod=gestor-factura" class="btn btn-danger btn-lg"><i class="glyphicon glyphicon-remove"></i><span> Cancelar</span></a>	&nbsp;&nbsp;&nbsp;	 <input type="submit" id="grabar" class="btn btn-primary btn-lg " value="Grabar" />
