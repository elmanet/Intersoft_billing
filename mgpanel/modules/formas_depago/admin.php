...
$query_modulo = "SELECT *  FROM sis_formapago";
...
<div class="tablaestilo" id="tabla_modulo">
		<table summary="Usuarios" width="90%">
				<caption>Gestor de Formas de Pago</caption>
				<thead>
              <tr >
 				 
              <th width="40%" height="35"  align="center" scope="col" ><b>Tipo de Pago</b></th>
              ...
              <?php do { ?>
              <tr class="odd">
              <td  height="26" align="center" ><?php echo strtoupper($row_modulo['titulo_fpago']); ?></td>
              <td  align="center" >
				  ...
				  <td  align="center" ><a href="modificar.php?id=<?php echo $row_modulo['id_fpago'];?>"><img src="../../images/png/32px-Crystal_Clear_action_reload.png" alt="" width="16" ></a>&nbsp;<a href="eliminar.php?id=<?php echo $row_modulo['id_fpago'];?>" class="ask-custom"><img src="../../images/png/cancel_f2.png" alt="" width="16"></a></td>
            ...
            <img src="../../images/iconfinder/vacio.png" alt="" width="200">
				<p style="font-size:19px;">"No Hay Formas de Pago Registradas!"</p>            
            </center>
            <?php } ?>
            <br />
            <br />
